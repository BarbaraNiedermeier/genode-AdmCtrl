...
namespace Sched_controller {
	...
	struct Session : Genode::Session
	{
		...
		virtual void optimize (Genode::Ram_dataspace_capability) = 0;
		...
		GENODE_RPC(Rpc_optimize, void, optimize, Genode::Ram_dataspace_capability);
		GENODE_RPC_INTERFACE(Rpc_get_init_status, Rpc_new_task, Rpc_set_sync_ds, Rpc_are_you_ready, Rpc_update_rq_buffer, Rpc_optimize);
	};
}
