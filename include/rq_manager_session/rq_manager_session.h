...
namespace Rq_manager {
	...
	struct Session : Genode::Session
	{
		...
		virtual int enq(int, Rq_task::Rq_task) = 0;
//		virtual int deq(int, Rq_task**) = 0;
		virtual int get_num_rqs() = 0;
		...
		GENODE_RPC(Rpc_enq, int, enq, int, Rq_task::Rq_task);
//		GENODE_RPC(Rpc_deq, int, deq, int, Rq_task**);
		GENODE_RPC(Rpc_get_num_rqs, int, get_num_rqs);
